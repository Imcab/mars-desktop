...
| [`extension/`](extension/README.md) | **MARS for VS Code**: the editor half. Reads a robot project's architecture out of its Java and puts it in the sidebar, over the declarations, and in the problems panel. |
